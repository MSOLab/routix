...
class SolutionManager(Generic[SubroutineReportT, SolutionT], ABC):
    ...
    def register(
        ...
        report: SubroutineReportT,
        solution: SolutionT | None,
        force_update_ref_sol: bool = True,
    ) -> bool:
        """
        ...
        Args:
            ...
            force_update_ref_sol (bool): If True, ref_solution is always updated to the new solution.
                If False, ref_solution is only updated when best_solution improves.
        ...
        if self._a_is_better_obj_value(new_obj_value, self.best_obj_value):
            ...
            logging.info(f"Best & ref. solution updated with objective: {self.best_obj_value}")
